...
function populate_project(aPackage, aCb) {
...
function get_package_by_id(aId, aCb) {
    exports.Package.find(aId, function (err, package) {
        populate_project(package, function () {
            aCb(package);
        });
    });
}
...
function populate_packages(aProject, aCb) {
...
function get_project_by_id(aId, aCb) {
    exports.Project.find(aId, function (err, project) {
        populate_packages(project, function () {
            aCb(project);
        });
    });
}
