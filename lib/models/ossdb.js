...
function set_license(aLicense, aCb) {
    exports.License.upsert(aLicense, function (err, license) {
        aCb(license);
    });
}
...
function set_package(aPackage, aCb) {
    exports.License.upsert(aPackage, function (err, p) {
        aCb(p);
    });
}
...
function set_project(aProject, aCb) {
    exports.License.upsert(aProject, function (err, p) {
        aCb(p);
    });
}
